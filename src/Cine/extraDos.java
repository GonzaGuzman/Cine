...
public class extraDos {
    ...
    /**
     ejercicio sin terminar, falta desarrollar reserva de asientos con atributo espectador,
     * falta reformar codigo del parseado de JOptionPain en lugar de 
     * int aux = Integer.ParseInt(JOptionPane.ShowImputDialog("X")) hacer
     * String aux =JOptionPane.ShowImputDialog("X");
     * if (aux!=null)
    ...
    public static void main(String[] args) {
        ...
        ArrayList<Espectador> user = new ArrayList();
        CineSc.menuEmpresa(salas, cartelera, user);
